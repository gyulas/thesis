...
Azok a legújabb építésű, fenntartható irodaházak, amelyek LEED, illetve WELL minősítést kapnak, az emberek egészségének és jó közérzetének fenntartását is segítik\footnote{A LEED (Leadership in Energy and Environmental Design) egy komplex minősítési rendszer, a szakdolgozat tematikájához az \textit{Energia és légkör} kategória tartozik. Bővebben: https://www.terc.hu/tudastar/leed \\
...
A törvényi javaslat a helyiségenkénti szabályozásra szakmailag megalapozott: egy elosztottan működő rendszer figyelembe tudja venni azokat a jellemzőket, melyek az egész épületre nem állandók, például a napsütés függhet a helyiség orientációjától vagy hogy hány ablak van rajta
