...
Én a fizikai modell felírását választottam, a szabályzótervezéshez ezt identifikálva átviteli függvényt kapok. Ehhez sokkal egyszerűbb eljutni, mint mérésekkel:
...
Helyiségenkénti hőmérséklet-szabályzást valósítok meg, azaz a belső hőmérsékletre egy referenciajel és egy mért hőmérséklet értelmezett. A helyiség levegőjének hőmérsékletét mindenhol ugyanakkorának (homogénnek) feltételezem. A szabályzás külső behatások ellenében történik, úgy mint alacsonyabb külső hőmérséklet (szóba jöhet a napsütés, szellőzés hatása is). Nem foglalkozok belső zavarással, ami származhat helyiségek közti hőmérséklet-különbségből\footnote{A modellezés egyszerűsítése végett több helyiség egymásra hatását nem veszem figyelembe.}, vagy emberek jelenlétéből.
