...
A következőkben egy radiátort és egy padlófűtést fogok modellezni, ezekre képlettel felírom az állandósult állapotbeli hőleadást. Szimuláció során olyan bekapcsolási tranziensekkel is számolnom kell, amik egy kis időállandós fűtés (pl. légbefúvás, fan-coil) esetén elhanyagolhatók lennének. Ehhez már a Matlab Simscape környezetét fogom használni, amely képes termikus rendszerek modellezésére.
