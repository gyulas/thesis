\begin{table}[H]
	...
	\begin{tabu}{|p{3cm}|p{3cm}|p{3cm}|p{2.8cm}|c|}
		\cline{2-5}
...
%		& First flight & Second flight\\ \hline
		...
		\multirow{2}{*}
					{Radiátor, h=900\si{\milli\metre}} 	 & Víz 		& 	& 8.9l/m 	&	\\  \cline{2-5}
								 & Fémtest 	& 	& 50.1 \si[per-mode=fraction]{\kilogram\per\metre}	& 	\\  \hline
								 
		\multicolumn{5}{c}{}\\ \hline
		
		\multirow{3}{*}
					{Padlófűtés} & Víz 		&	&  	&	\\  \cline{2-5}
								 & Födém 	&	& 840  \si[per-mode=fraction]{\kilogram\per\metre\squared}	&	\\  \cline{2-5}
								 & Padló burkolat 	& $h_c, h_r$ 	&	& 	\\  \hline
	\end{tabu}						
