...
RT_MODEL_udp_conn_T *udp_conn(void)
{
  ...
  rtmSetTFinal(udp_conn_M, 4.0);
  udp_conn_M->Timing.stepSize0 = 2.0;
  udp_conn_M->Timing.stepSize1 = 2.0;

  /* External mode info */
  udp_conn_M->Sizes.checksums[0] = (2660585606U);
  udp_conn_M->Sizes.checksums[1] = (556286141U);
  udp_conn_M->Sizes.checksums[2] = (3243991894U);
  udp_conn_M->Sizes.checksums[3] = (2883090482U);
