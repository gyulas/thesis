...
MODEL                := sldrtex_packetio
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c sldrtex_packetio_data.c sldrtex_packetio_tgtconn.c 
MAKEFILE             := sldrtex_packetio.mk
...
#
MODELLIB                  := sldrtex_packetiolib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sldrtex_packetio_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/gylaszlo.SCH/Documents/szakdoga/thesis/simulations/tuske/sldrtex_packetio_sldrt_win64;C:/Users/gylaszlo.SCH/Documents/szakdoga/thesis/simulations/tuske;$(MATLAB_ROOT)/toolbox/sldrt/sldrtexamples;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
