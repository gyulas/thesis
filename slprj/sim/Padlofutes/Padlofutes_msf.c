...
#define S_FUNCTION_NAME Padlofutes_msf
#endif
...
) { ap0aiyhvxwb * dw = ( ap0aiyhvxwb * ) ssGetDWork ( S , 0 ) ; const real_T
* i_k1vjmqm2im = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; const real_T *
i_ldivqs1ezi = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; const real_T *
i_j2o3yb4ch2 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; const real_T *
i_n4e41wexur = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) { Padlofutes
( i_k1vjmqm2im , i_ldivqs1ezi , i_j2o3yb4ch2 , i_n4e41wexur , o_B_1_1 , & (
dw -> rtb ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( (
...
mr_Padlofutes_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2 )
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_Padlofutes_MdlInfoRegFcn
( S , "Padlofutes" , & retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( ap0aiyhvxwb ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { ap0aiyhvxwb * dw = (
ap0aiyhvxwb * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } iffcfnyznu
...
* S , int_T tid ) { ap0aiyhvxwb * dw = ( ap0aiyhvxwb * ) ssGetDWork ( S , 0 )
; const real_T * i_k1vjmqm2im = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
const real_T * i_ldivqs1ezi = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
const real_T * i_j2o3yb4ch2 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
const real_T * i_n4e41wexur = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { PadlofutesTID1 ( & ( dw -> rtb ) ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 ,
tid ) || ssIsMinorTimeStep ( S ) ) { Padlofutes ( i_k1vjmqm2im , i_ldivqs1ezi
, i_j2o3yb4ch2 , i_n4e41wexur , o_B_1_1 , & ( dw -> rtb ) ) ; } } } static
void mdlTerminate ( SimStruct * S ) { ap0aiyhvxwb * dw = ( ap0aiyhvxwb * )
ssGetDWork ( S , 0 ) ; myjxmqf5uc ( & ( dw -> rtm ) ) ; return ; }
...
simStateFieldNames ) ; { mxArray * mdlrefDW = mr_Padlofutes_GetDWork (
ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } {
mxArray * data = mr_Padlofutes_GetSimStateDisallowedBlocks ( ) ;
...
mr_Padlofutes_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss , 0 ,
