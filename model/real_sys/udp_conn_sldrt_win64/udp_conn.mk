...
MODEL                := udp_conn
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c udp_conn_data.c udp_conn_tgtconn.c
MAKEFILE             := udp_conn.mk
...
#
MODELLIB                  := udp_connlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := udp_conn_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/gylaszlo.SCH/Documents/szakdoga/thesis/model/real_sys;C:/Users/gylaszlo.SCH/Documents/szakdoga/thesis/model/real_sys/udp_conn_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
