...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* udp_conn_COMMON_INCLUDES_ */

#include "udp_conn_types.h"
...
#define udp_conn_rtModel               RT_MODEL_udp_conn_T
...
typedef struct {
  ...
  boolean_T iAout[2];                  /* '<S5>/optimizer' */
} B_udp_conn_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T last_mv_DSTATE;               /* '<S5>/last_mv' */
  real_T last_x_PreviousInput[4];      /* '<S5>/last_x' */
  void *PacketInput1_PWORK;            /* '<Root>/Packet Input1' */
  struct {
    void *LoggedData[3];
  } Scope_PWORK;                       /* '<Root>/Scope' */

  boolean_T Memory_PreviousInput[2];   /* '<S5>/Memory' */
} DW_udp_conn_T;

/* Backward compatible GRT Identifiers */
#define rtB                            udp_conn_B
#define BlockIO                        B_udp_conn_T
#define rtP                            udp_conn_P
#define Parameters                     P_udp_conn_T
#define rtDWork                        udp_conn_DW
#define D_Work                         DW_udp_conn_T
...
extern P_udp_conn_T udp_conn_P;

/* Block signals (default storage) */
extern B_udp_conn_T udp_conn_B;
 ...
 * External functions *
 *====================*/
extern udp_conn_rtModel *udp_conn(void);
...
extern RT_MODEL_udp_conn_T *const udp_conn_M;
 ...
 * '<S6>'   : 'udp_conn/MPC Controller/MPC/MPC Matrix Signal Check'
 * '<S7>'   : 'udp_conn/MPC Controller/MPC/MPC Matrix Signal Check1'
 * '<S8>'   : 'udp_conn/MPC Controller/MPC/MPC Matrix Signal Check2'
 * '<S9>'   : 'udp_conn/MPC Controller/MPC/MPC Preview Signal Check'
 * '<S10>'  : 'udp_conn/MPC Controller/MPC/MPC Preview Signal Check1'
 * '<S11>'  : 'udp_conn/MPC Controller/MPC/MPC Preview Signal Check2'
 * '<S12>'  : 'udp_conn/MPC Controller/MPC/MPC Preview Signal Check3'
 * '<S13>'  : 'udp_conn/MPC Controller/MPC/MPC Preview Signal Check4'
 * '<S14>'  : 'udp_conn/MPC Controller/MPC/MPC Scalar Signal Check'
 * '<S15>'  : 'udp_conn/MPC Controller/MPC/MPC Scalar Signal Check1'
 * '<S16>'  : 'udp_conn/MPC Controller/MPC/MPC Vector Signal Check'
 * '<S17>'  : 'udp_conn/MPC Controller/MPC/MPC Vector Signal Check1'
 * '<S18>'  : 'udp_conn/MPC Controller/MPC/MPC Vector Signal Check11'
 * '<S19>'  : 'udp_conn/MPC Controller/MPC/MPC Vector Signal Check2'
 * '<S20>'  : 'udp_conn/MPC Controller/MPC/MPC Vector Signal Check3'
 * '<S21>'  : 'udp_conn/MPC Controller/MPC/MPC Vector Signal Check4'
 * '<S22>'  : 'udp_conn/MPC Controller/MPC/MPC Vector Signal Check5'
 * '<S23>'  : 'udp_conn/MPC Controller/MPC/MPC Vector Signal Check6'
 * '<S24>'  : 'udp_conn/MPC Controller/MPC/optimizer'
 */
