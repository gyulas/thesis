...
#ifndef RTW_HEADER_tuske_sldrtex_packetio_h_
#define RTW_HEADER_tuske_sldrtex_packetio_h_
#include <math.h>
#include <string.h>
#ifndef tuske_sldrtex_packetio_COMMON_INCLUDES_
# define tuske_sldrtex_packetio_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* tuske_sldrtex_packetio_COMMON_INCLUDES_ */

#include "tuske_sldrtex_packetio_types.h"
...
} DW_tuske_sldrtex_packetio_T;

/* Backward compatible GRT Identifiers */
#define rtB                            tuske_sldrtex_packetio_B
#define BlockIO                        B_tuske_sldrtex_packetio_T
#define rtP                            tuske_sldrtex_packetio_P
#define Parameters                     P_tuske_sldrtex_packetio_T
...
struct P_tuske_sldrtex_packetio_T_ {
  ...
  int32_T PacketInput_PacketID;        /* Mask Parameter: PacketInput_PacketID
                                        * Referenced by: '<Root>/Packet Input'
                                        */
  real_T SineWavedouble_Amp;           /* Expression: 100
...
struct tag_RTM_tuske_sldrtex_packetio_T {
  const char_T *path;
 ...
 * External functions *
 *====================*/
extern tuske_sldrtex_packetio_rtModel *tuske_sldrtex_packetio(void);
...
extern RT_MODEL_tuske_sldrtex_packetio_T *const tuske_sldrtex_packetio_M;
 ...
 *
 * '<Root>' : 'tuske_sldrtex_packetio'
 */
#endif                                 /* RTW_HEADER_tuske_sldrtex_packetio_h_ */
