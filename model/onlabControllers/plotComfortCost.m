function plotComfortCost(varargin)
...
%set X axes label
plotting_axesLabel_Day()
legend('Referenciajel t_{ref}','Helyiség hõmérséklete t_i')
%,'Nemlineáris modell t_i','Linearizált modell t_i')
leg=get(gca, 'Legend');
leg.Position =[0.5930 0.5337 0.3134 0.0822];
subtitle=get(hMeasured,'Title');
subtitle.String='Belsõ hõmérséklet';
subtitle.FontSize=11;
...
subtitle=get(hMeasured,'Title');
subtitle.String='Külsõ hõmérséklet';
subtitle.FontSize=11;
plotting_axesLabel_Day()
