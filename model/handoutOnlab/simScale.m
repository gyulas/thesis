...
grid on
set(gca,'XTickLabel',{'Nincs','R5D10','Súlyozott R10D48'})
title('Súlyozás hatása a beavatkozók arányára')
...
ComfortViolation.max=[A_C_PreviewRef0_Dist0.signals(4).values(4,9) ...
                        ...
                        Cdiff_PrevRef10Dist48.signals(4).values(4,9)];                       
...
RequiredPower.max=[A_C_PreviewRef0_Dist0.signals(4).values(1,8) ...
                        A_C_PreviewRef5_Dist10.signals(4).values(1,8) ...
                        Cdiff_PrevRef10Dist48.signals(4).values(1,8)];
EnergyConsumption.sum=[A_C_PreviewRef0_Dist0.signals(4).values(4,8) ...
                        A_C_PreviewRef5_Dist10.signals(4).values(4,8) ...
                        Cdiff_PrevRef10Dist48.signals(4).values(4,8)];
...
title({'Peak Demand - max. teljesítményigény';'Previewing és súlyozás hatása'})
